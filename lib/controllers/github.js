...
module.exports = Router()
    ...
    .get('/callback', async (req, res, next) => {
        try {
            ...
            const jwtReturn = jwt.sign(user.toJSON(), process.env.JWT_SECRET, { expiresIn: '1 day' });

            res.cookie(process.env.COOKIE_NAME, jwtReturn, { httpOnly: true, maxAge: ONE_DAY_IN_MS }).redirect('/api/v1/github/test')
        } catch(e) {
            next(e);
        }
    });